...
/**
 * 创建配置好的 Express 应用
 * @param {Object} dirs - 目录配置 { books, config, fonts }
 * @returns {{ app: Express, utils: Object, DIRS: Object, ALLOWED_EXTENSIONS: string[] }}
 */
function createApp(dirs) {
  const DIRS = dirs;
  const app = express();
  ...
  return { app, utils, DIRS, ALLOWED_EXTENSIONS };
}
